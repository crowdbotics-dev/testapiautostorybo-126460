...
## Project Structure
    ...
    ├── testapiautostorybo_126460  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_126460`
...
2. Clone this repo and `cd testapiautostorybo_126460`
